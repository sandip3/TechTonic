...
export default function Profile() {
  ...
  const registeredEvents = events.filter(
    e => e.registrations?.includes(currentUser?.uid) && e.creatorId !== currentUser?.uid
  );
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              Manage your public profile and account info.
            </p>
          </div>
                  ...
                  <form
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="name"
                        type="text"
                        placeholder="e.g. MIshra Sandip Manoj"
                        value={form.name}
                      ...
                      {currentUser?.skills ?
                        <div className="flex flex-wrap gap-1.5">
                          {currentUser.skills.split(',').map((skill, i) => (
                            <span
                              key={i}
                              className="badge bg-blue-50 text-blue-700 border border-blue-100">
                              {skill.trim()}
                            </span>
                          ))}
                        </div>
